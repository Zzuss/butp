...
export default function TestUmamiConnection() {
  ...
  const runDiagnostics = async () => {
    ...
    try {
      ...
      const response = await fetch('https://umami-mysql-mauve.vercel.app', { 
        method: 'HEAD',
      ...
      updateTest(1, {
        ...
        details: { 
          error: error instanceof Error ? error.message : '未知错误',
          serverUrl: 'https://umami-mysql-mauve.vercel.app',
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                ...
                <li>检查服务器URL: https://umami-mysql-mauve.vercel.app</li>
                <li>等待5-10分钟后重试</li>
                <li>
                  访问 
                  <Button 
                    ...
                    onClick={() => window.open('https://umami-mysql-mauve.vercel.app', '_blank')}
                  >
                    Umami控制台
              ...
              <div className="space-y-2">
                ...
                <div className="bg-gray-100 p-3 rounded text-sm font-mono">
                  <div className="flex items-center justify-between">
                    <span>UMAMI_BASE_URL=https://umami-mysql-mauve.vercel.app</span>
                    <Button size="sm" variant="ghost" onClick={() => copyToClipboard('UMAMI_BASE_URL=https://umami-mysql-mauve.vercel.app')}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button variant="outline" onClick={() => window.open('https://umami-mysql-mauve.vercel.app/dashboard', '_blank')}>
